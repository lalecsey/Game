...
HANGMAN_PICS = ['''
 ...
 / \  |
     ===''']
words = 'аист акула бабуин баран барсук бобр бык верблюд волк воробей ворон выдра голубь гусь жаба зебра змея индюк кит кобра коза козел койот корова кошка кролик крыса лебедь лев лиса лосось лось лягушка медведь моллюск моль мул муравей мышь норка носорог обезьяна овца окунь олень орел осел панда паук питон попугай пума семга скунс собака сова тигр тритон утка форель хорек черепаха ястреб ящерица'.split()
...
def playAgain():
    #Эта функция возвращает значение True, если                 
...
while True:
    ...
    if guess in secretWord:
        ...
        if len(missedLetters) == len(HANGMAN_PICS) - 1:
            ...
            gameIsDone = True
        # Запрашивает, хочет ли игрок сыграть заново (только если игра завершина).
        if gameIsDone:
            if playAgain():
                missedLetters = ''
                correctLetters = ''
